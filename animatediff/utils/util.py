...
def save_videos_grid(videos: torch.Tensor, path: str, rescale=False, n_rows=6, fps=8, mp4_also=False):
    ...
    if mp4_also:
        imageio.mimsave(path.replace(".gif", ".mp4"), outputs, fps=fps)
        

def save_video_as_images(video: torch.Tensor, path: str, rescale=False):
